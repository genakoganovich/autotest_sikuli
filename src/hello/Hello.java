...
public class Hello {
    ...
    public static void main(String[] args) {
        Screen s = new Screen();
        Hello.addDB(s, DB_NAME, "C:/data/", DB_STORAGE_DESCRIPTION);
    } // main

    public static void addDB(Screen s, String dbName, String folder, String dbStorageDescription) {
        try {
            ...
            Hello.selectAllPaste(s, STORAGE_DESCRIPTION_INPUT_IMAGE, dbStorageDescription);
